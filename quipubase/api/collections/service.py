...
from .typedefs import Collection
from quipubase.lib.utils import get_logger, singleton
...
class CollectionManager:
    ...
    def __init__(self):
        try:
            ...
            logger.info(f"Initialized CollectionManager with database at {self.db_path}")
    ...
    def get_json_schema(self, collection_id: str) -> JsonSchemaModel:
        ...
        try:
            ...
            logger.error(f"Failed to get schema for collection '{collection_id}': {str(e)}")
            raise QuipubaseException(
                status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
        ...
        try:
            ...
            if collection_path.exists():
                ...
                try:
                    ...
                    logger.error(f"Failed to delete collection directory '{collection_path}': {str(e)}")
                    raise QuipubaseException(
                        status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
